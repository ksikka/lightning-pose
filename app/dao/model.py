...
MODEL_TYPE_MAP = {"heatmap": "Heatmap",
...
class Model:
    ...
    def __setattr__(self, name: str, value: any) -> None:
        ...
        if name in ('model_type', 'losses_to_use'):
            self.display_model_type = "Supervised" if not self.display_losses_to_use else "Unsupervised"
            self.display_model_type += " " + self.display_model_arch if self.model_type == "heatmap_mhcrnn" else ""
    ...
    def list(cls):
        ...
        for root, _, files in os.walk(model_dir):
            ...
            if "config.yaml" in files:
                ...
                file_info.append(cls(str(relative_path), creation_timestamp, creation_timestamp_fmt))
