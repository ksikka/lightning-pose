...
class ModelComponentContainer(Protocol):
    ...
    def get_steps_for_epoch(self) -> int: ...

    def get_logger(self) -> pl.logging.Logger: ...

    def get_callbacks(self) -> list[pl.callbacks.Callback]: ...

    def get_training_trainer(self) -> pl.Trainer: ...

    def get_prediction_trainer(self) -> pl.Trainer: ...
